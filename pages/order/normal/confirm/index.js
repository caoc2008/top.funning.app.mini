  ...
  getData: function() {
    ...
    wq.request("C1006", {
      ...
      success: function(data) {
        console.log(data);
        data.state = "show";
        data.priceAmount = data.priceAmount == null ? data.price : data.priceAmount;
        data.address = {
        ...
        if (data.detailInfo) {
          data.addressExist = true;
        } else {
          data.addressExist = false;
        }
        that.setData(data);
      },
        ...
        addrUtils.computer({
          ...
          onSuccess: function(poster) {
            ...
            that.setData({
              "address": address,
              "poster": poster,
              "priceAmount": (Number(that.data.price) + Number(poster)),
              "addressExist": true
            });
          },
          onFail: function(msg) {
